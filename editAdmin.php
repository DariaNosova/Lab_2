...
<div class="formWrapper">
    <form method="post" action="php/changeAdmin.php" id="editForm" name="editForm">
        ...
        <p><button name="submit" type="submit" value="Update" class="btn btn-primary">Update</button></p>
    </form>
</div>
